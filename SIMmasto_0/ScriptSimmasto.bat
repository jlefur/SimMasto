...
rem Java path
set JAVAPATH="C:\progra~1\Java\jre6\bin\java.exe"

rem The plugins path of Eclipse.
set PLUGINS=C:\Repast~1.0-B\eclipse\plugins
...
set MODELFOLDER=C:\DOCUME~1\jlefur\MESDOC~1\Worksp~2\%MODELNAME%
...
rem repast.simphony.runtime.RepastBatchMain / repast.simphony.batch.BatchMain
ECHO RUN
