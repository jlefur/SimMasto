...
for (plan in lesPlans){
  ...
  # pour chaque mesure de gestion
      ...
      print(res_ssr)
      jpeg(filename = paste("Graphiques/PIIQ6_",plan,"_ss_regles_Y",i,".jpg",sep=""))
      ...
      print(res_amp)
      jpeg(filename = paste("Graphiques/PIIQ6_",plan,"_AMP_Y",i,".jpg",sep=""))
      par(las=2,mar=c(15,3,2,2))
      ...
      print(res_tac)
      jpeg(filename = paste("Graphiques/PIIQ6_",plan,"_TAC_Y",i,".jpg",sep=""))
      par(las=2,mar=c(15,3,2,2))
